...
class PassHolderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->cfPassHolderFull->uitIdUser->optInPreferences = new \CultureFeed_Uitpas_Passholder_OptInPreferences();
        $this->cfPassHolderFull->uitIdUser->optInPreferences->optInServiceMails = true;
        $this->cfPassHolderFull->uitIdUser->optInPreferences->optInMilestoneMails = true;
        $this->cfPassHolderFull->uitIdUser->optInPreferences->optInInfoMails = true;
        $this->cfPassHolderFull->uitIdUser->optInPreferences->optInSms = true;
        $this->cfPassHolderFull->uitIdUser->optInPreferences->optInPost = true;
